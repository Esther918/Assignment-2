...
node1.apply_force([0.1, -0.05, -0.075, 0, 0, 0])  # [Fx, Fy, Fz, Mx, My, Mz]
node2.apply_force([0, 0, 0, 0.5, -0.1, 0.3])  # [Fx, Fy, Fz, Mx, My, Mz]
...
E2 = BeamElement3D(2, 3, E, nu, A, Iy, Iz, J, nodes)
E3 = BeamElement3D(2, 4, E, nu, A, Iy, Iz, J, nodes)

# Fix Node 0, Node 3, Node 4
node0.set_boundary_condition([False, False, True, False, False, False])
node3.set_boundary_condition([True, True, True, True, True, True])
node4.set_boundary_condition([True, True, True, False, False, False])
